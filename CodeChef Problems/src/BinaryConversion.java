...
public class BinaryConversion {
    ...
    private static void solve(PrintWriter out) {
        ...
        for (int i = 0; i < n; i++) {
            if(s.charAt(i) == '0') sCnt0++;
            if(s.charAt(i) == '1') sCnt1++;
            if(t.charAt(i) == '0') tCnt0++;
            if(t.charAt(i) == '1') tCnt1++;
        }

        if(sCnt1 != tCnt1 || sCnt0 != tCnt0){
            System.out.println("NO");
            return;
        }

        int req1Op = 0, req0Op = 0;
        boolean gotEqual = false;
        for (int i = 0; i < n; i++) {
            if(s.charAt(i) != t.charAt(i)){
                if(s.charAt(i) == '0') req1Op++;
                if(s.charAt(i) == '1') req0Op++;
            }
            else{
                gotEqual = true;
            }
        ...
        if(req1Op == req0Op){
            if(req1Op < k){
                if(gotEqual) System.out.println("YES");
                else{
                    if((k - req1Op) % 2 == 0){
            ...
            else if(req1Op > k) System.out.println("NO");
