...
public class ChefLovesPizzaChefLovesHalfs {
    ...
    private static void solve(PrintWriter out) {
        ...
        int power = 1;
        while(true){
            long equalSlices = (long)Math.pow(2,power);
            long nextEqualSlices = (long)Math.pow(2,power+1);
            if(equalSlices == x){
                System.out.println(0);
                return;
            }
            if(x > equalSlices && x < nextEqualSlices){
                long rem = nextEqualSlices - x;
