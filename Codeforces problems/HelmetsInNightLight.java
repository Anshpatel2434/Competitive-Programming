...
//        al.sort(new Comparator<List<Integer>>() {
//            @Override
...
//        });
        ...
        //al.sort((o1, o2) -> Integer.compare(o1.get(0), o2.get(0)));

        long remainingHouses = n, cost = 0;
        for (int i = 0; i < map.size(); i++) {
            if(sortedKeys.get(i) >= p){
                cost += p * remainingHouses;
                ...
                for (Integer reach:
                     map.get(sortedKeys.get(i))) {
                    if(reach >= remainingHouses){
                        cost += sortedKeys.get(i) * remainingHouses;
                        System.out.println(cost);
                        return;
                    }
                    else{
                        remainingHouses -= reach;
                        cost += reach * sortedKeys.get(i);
                    }
                }
            }
        }
